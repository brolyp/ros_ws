...
class Real2Sim_Dynamic_Publisher(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(JointTorque, "joint_torque", self.simulate, 10)
    ...
    def simulate(self, taulist :JointTorque):
        ...
        self.get_logger().info(f'Executing dynamics status :: {states.message}')
        return states

    def qd_func(self, thetad):
        return thetad

    def dSdt(self, t,S , tau):
        ...
        #self.get_logger().info(f'Executing dynamics with tau :: {tau}')
