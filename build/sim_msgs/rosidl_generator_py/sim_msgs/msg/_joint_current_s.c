...
bool sim_msgs__msg__joint_current__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sim_msgs.msg._joint_current.JointCurrent", full_classname_dest, 40) == 0);
  }
  sim_msgs__msg__JointCurrent * ros_message = _ros_message;
  {  // header
...
PyObject * sim_msgs__msg__joint_current__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sim_msgs.msg._joint_current");
