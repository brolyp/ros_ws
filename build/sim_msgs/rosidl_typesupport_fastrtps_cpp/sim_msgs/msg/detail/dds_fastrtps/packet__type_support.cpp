...
#include "sim_msgs/msg/detail/packet__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const sim_msgs::msg::Packet *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sim_msgs::msg::Packet *>(
    untyped_ros_message);
...
{
  return &sim_msgs::msg::typesupport_fastrtps_cpp::_Packet__handle;
}
