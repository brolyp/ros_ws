...
#include "sim_msgs/msg/detail/joint_current__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // current
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // current
...
using _JointCurrent__ros_msg_type = sim_msgs__msg__JointCurrent;
...
static uint32_t _JointCurrent__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sim_msgs__msg__JointCurrent(
...
static size_t _JointCurrent__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sim_msgs__msg__JointCurrent(
