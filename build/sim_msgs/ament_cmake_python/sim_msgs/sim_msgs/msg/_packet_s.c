...
bool sim_msgs__msg__packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sim_msgs.msg._packet.Packet", full_classname_dest, 27) == 0);
  }
  sim_msgs__msg__Packet * ros_message = _ros_message;
  {  // device_id
  ...
  {  // packet_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "packet_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->packet_id = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // data
...
PyObject * sim_msgs__msg__packet__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sim_msgs.msg._packet");
  ...
  {  // packet_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->packet_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "packet_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
