...
class Packet(metaclass=Metaclass_Packet):
    ...
    def __init__(self, **kwargs):
        ...
        self.packet_id = kwargs.get('packet_id', int())
    ...
    def packet_id(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'packet_id' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'packet_id' field must be an unsigned integer in [0, 255]"
